      ...
      <div className="inner-footer-container">
          ...
          <div className="footer-intro-container">
            <a href="/">
              <svg
                ...
                viewBox="0 0 96 24"
                role="img"
                aria-labelledby="abxs4edys7u2uz2ubd8opq40pjf67og8"
                class="icon dribbble-wordmark"
              >
                <title id="abxs4edys7u2uz2ubd8opq40pjf67og8">
            ...
            <div class="social-container">
              ...
              <a className="twitter-link" href="http://twitter.com/dribbble">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  aria-labelledby="ao6vxar401047e9d2n49twhusp9gmmxc"
                  role="img"
                  viewBox="0 0 24 24"
                  class="icon fill-current"
                >
                  <title id="ao6vxar401047e9d2n49twhusp9gmmxc">
                    Twitter icon
                  </title>
              ...
              <a className="facebook-link" href="http://facebook.com/dribbble">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  aria-labelledby="anspep2ezaub2qirayznu4r8718gpy1l"
                  role="img"
                  viewBox="0 0 24 24"
                  class="icon fill-current"
                >
                  <title id="anspep2ezaub2qirayznu4r8718gpy1l">
                    Facebook icon
                  </title>
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  aria-labelledby="ahk9d42m4o9kh2bx4n3q99tsfp7y2ff5"
                  role="img"
                  viewBox="0 0 24 24"
                  class="icon fill-current"
                >
                  <title id="ahk9d42m4o9kh2bx4n3q99tsfp7y2ff5">
                    Pinterest icon
                  </title>
            ...
            <div className="links-container">
              <div className="links-column">
                ...
                <a className="link" href="/pro">
                  Go Pro!
                </a>
                <a className="link" href="/shots">
                  Explore design work
                </a>
                <a className="link" href="/stories">
                  Design blog
                </a>
                <a className="link" href="/overtime">
                  Overtime podcast
                </a>
                <a className="link" href="/shots?list=playoffs">
                  Playoffs
                </a>
                <a
                  className="link"
                  href="/shots/19651233-Design-a-modern-logo-for-a-new-dog-grooming-service"
                >
                  Weekly Warm-Up
                </a>
              ...
              <div className="links-column">
                ...
                <a className="link" href="/jobs/new">
                  Post a job opening
                </a>
                <a className="link" href="/freelance-jobs">
                ...
                <a className="link" href="/advertise">
                  Advertise with us
                </a>
              </div>
              <div className="links-column">
                ...
                <a className="link" href="/media-kit">
                  Media kit
                </a>
                <a className="link" href="/testimonials">
                  Testimonials
                </a>
                <a className="link" href="https://developer.dribbble.com">
                  API
                </a>
              ...
              <div class="links-column">
                ...
                <a rel="noopener" class="link" href="/resources/freelance">
                  Freelancing
                </a>
                <a rel="noopener" class="link" href="/resources/design-hiring">
                  Design Hiring
                </a>
                <a
                  rel="noopener"
                ...
                <a rel="noopener" class="link" href="/resources/education">
                  Design Education
                </a>
                <a
                  rel="noopener"
        ...
        <div className="footer-lower-container">
            <div className="copyright-container">
                ©️ 2022 Dribble. All rights reserved
            </div>
            <div className="logo-container">
                <div className="counts-container">
                <span className="counts">19,665,368</span>
                <>{"\u00a0\u00a0"}</>
                <span className="count-letters">Shots dribbbled</span>
                <img className="dribble-ball" src={logo} alt="logo" width="24px" height="24px"></img>
                </div>
